...
(function (t) {
	...
	t.extend(t.validator, {
		...
		messages : {
			...
			number : "Harus diisi angka saja, spasi tidak diperbolehkan",
			digits : "Harus diisi angka saja, spasi tidak diperbolehkan",
			creditcard : "Please enter a valid credit card number.",
			equalTo : "Nilai yang dimasukkan tidak sama.",
			maxlength : t.validator.format("Tidak boleh melebihi {0} karakter."),
			minlength : t.validator.format("Harus lebih dari {0} karakter."),
			rangelength : t.validator.format("Panjang karakter antara {0} dan {1}."),
			range : t.validator.format("Masukkan nilai antara {0} dan {1}."),
			max : t.validator.format("Tidak boleh lebih dari {0}."),
			min : t.validator.format("Tidak boleh kurang dari {0}.")
		},
		autoCreateRanges : !1,
		prototype : {
			init : function () {
